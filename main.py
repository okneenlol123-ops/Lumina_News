...
import requests, json, re, os, html
...
# ----------------------------
# Cache-Datei erstellen, falls nicht vorhanden
# ----------------------------
if not os.path.exists(CACHE_FILE):
    with open(CACHE_FILE, "w", encoding="utf-8") as f:
        json.dump({"articles": {}, "last_update": ""}, f, ensure_ascii=False, indent=2)
...
def clean_text(text):
    """Bereinigt HTML-Zeichen und unsichtbare Zeichen"""
    if not text:
        return ""
...
# UI
# ----------------------------
st.set_page_config(page_title="Lumina News v7.2", layout="wide")
st.title("🌐 Lumina News v7.2")
